#!/bin/bash
# Build RPM package for AI-System-DocAI V5I
...
echo "============================================================"
echo "Building RPM package for $APP_NAME"
echo "============================================================"
echo
...
BUILD_DIR="$PROJECT_DIR/build_rpm"
...
fpm -s dir -t rpm \
    ...
    -C "$BUILD_DIR" \
    -p "$PROJECT_DIR/dist/${APP_NAME}-${APP_VERSION}.x86_64.rpm" \
    .

echo
echo "============================================================"
echo "✅ RPM package built successfully!"
echo "Location: $PROJECT_DIR/dist/${APP_NAME}-${APP_VERSION}.x86_64.rpm"
echo "============================================================"
